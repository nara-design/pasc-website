            ...
            <div class="max-width slight-padding">
                ...
                <div class="border-top">
                    ...
                    <?php
                        ...
                        $sql = "SELECT id, publication_date, title, newsletter_link FROM pasc_newsletters ORDER BY publication_date DESC";
                        ...
                        if($result->num_rows > 0){
                            ...
                            while($row = $result->fetch_assoc()){
                                ...
                                // var_dump($row["title"]);
                                echo "<div class='news-row display-flex-row-only flex-space-between'>";
                            ...
                            echo "<p>Sorry, there are no newsletters!</p>";
                        }
