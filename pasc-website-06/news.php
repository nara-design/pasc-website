...
<body class="bg-img" id="news-bg">
    ...
    <main id="top">
        ...
        <div class="white-bg main-content">
            <div class="smaller-max-width slight-padding">
                ...
                <div class="border-top">
                    ...
                    <?php
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "<p class='navy-text news-row'>Sorry, there are no newsletters for the selected year!</p>";
                        }
