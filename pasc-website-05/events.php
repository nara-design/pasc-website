                    ...
                    <?php
                        ...
                        if($result->num_rows > 0){
                            ...
                            while($row = $result->fetch_assoc()){
                                ...
                                echo "<img style='width:100%;' src='" . $row["event_image"] . "'>";
                                ...
                                echo "<button style='margin:0;'><a class='orange-text' href='" . $row["registration_link"] . "'>Register</a></button>";
                                echo "</div>";
        ...
        <div class="footer-navy">
            ...
            <div class="footer-row max-width white-text display-flex flex-space-between">
                ...
                <div class="half-width">
                    ...
                    <button class="orange-text">become a partner <i class="fa-solid fa-arrow-right-long"></i></button>
                </div>
                <!-- partner text finish -->
